 ...
 * 
 * This variable will only have a value after retrieving
 * discount codes from the API.
 */
...
export function QRCodeForm({ QRCode: InitialQRCode }) {
    ...
    const onSubmit = useCallback(
        (body) => {
            (async () => {
                ...
                /**
                 * use (authenticated) fetch from App Bridge to send the request to the API and, 
                 * if successful, clear the form to reset the ContextualSaveBar and parse the response JSON.
                 */
     ...
     * 
     * Accepts a "fields" object that sets up each individual field with a default
     * value and validation rules.
     * 
     * Returns a "fields" object that is destructured to access each of the fields
     * individually, so they can be used in other parts of the component.
     * 
     * Returns helpers to manage form state, as well as component state that is based
     * on form state.
     */
    const {
        fields: {
    ...
    /**
     * This function is called with the selected product whenever the user clicks
     * "Add" in the ResourcePicker.
     * 
     * It takes the first item in the selection array and sets the selected product to
     * an object with the properties from the "selection" argument.
     * 
     * It updates the form state using the "onChange" methods attached to the form
     * fields.
     * 
    ...
    /**
     * This function updates the form state whenever a user selects a new discount
     * option.
     */
    ...
    /**
     * This function is called when a user clicks "Select product" or cancels the 
     * ProductPicker.
     * 
     ...
     * image URLs can be retrieved from the Admin.
     */
